...
import void (*OPB_typSize)(OPT_Struct, BOOLEAN);
import void (*OPB_verify)(OPT_Object*);


import void OPB_Assign (OPT_Node *x, OPT_Node y);
import OPT_Node OPB_BoolConst (INT16 value);
...
import void OPB_CodeInsert (OPT_Node *stat);
import void OPB_Construct (INT8 class, OPT_Node *x, OPT_Node y);
import void OPB_CopyAndSubst (OPT_Node *new, OPT_Node old);
...
import void OPB_InitInsert (OPT_Node *stat);
...
import void OPB_Lock (OPT_Node *x, OPT_Object self, BOOLEAN excl);
